...
void update_r(vector float *v1, vector float *sum, float *u, int vBlocks,
  ...
  volatile vector float tmp1_1, tmp1_2, tmp1_3;
  ...
  for (i = 0; i < rows; i++) {
    ...
    for (j = 0; j < in_loop; j++) {
      ...
      sum1_1 = vec_mula(tmp1_1, cast, sum1_1);
      sum1_2 = vec_mula(tmp1_2, cast, sum1_2);
      sum1_3 = vec_mula(tmp1_3, cast, sum1_3);
  ...
  for (j = 0; j < in_loop; j++) {
    ...
    sum1_1 = vec_muli(v_scale, sum1_1);
    sum1_2 = vec_muli(v_scale, sum1_2);
    sum1_3 = vec_muli(v_scale, sum1_3);
  ...
  for (i = 0; i < rows; i++) {
    ...
    for (j = 0; j < in_loop; j++) {
      ...
      tmp1_1 = vec_mulb(cast, sum1_1, tmp1_1);
      tmp1_2 = vec_mulb(cast, sum1_2, tmp1_2);
      tmp1_3 = vec_mulb(cast, sum1_3, tmp1_3);
