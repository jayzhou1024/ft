...
int main()
{
    ...
    *cache1 = 0x1;
    ...
    int Nrows = 128;
    int Ncols = 128;
    float *A = (float *)malloc(sizeof(float) * Nrows * Ncols * 2);
    float *Q = (float *)malloc(sizeof(float) * Nrows * Nrows * 2);
    float *R = (float *)malloc(sizeof(float) * Nrows * Ncols * 2);
    float *inv_A = (float *)malloc(sizeof(float) * Nrows * Ncols * 2);
    float *u = (float *)malloc(sizeof(float) * (Nrows > Ncols ? Nrows : Ncols) * 2);
    float *b = (float *)malloc(sizeof(float) * Nrows * 2);
    float *y = (float *)malloc(sizeof(float) * Nrows * 2);
    float *x = (float *)malloc(sizeof(float) * Ncols * 2);
