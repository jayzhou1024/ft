...
static void complex_sp_inv_cn(double y_real, double y_imag, double *z_real, double *z_imag);
static void complex_sp_div_cn(double x_real, double x_imag, double y_real, double y_imag, double *z_real, double *z_imag);
static void complex_sp_sqrt_cn(double x_real, double x_imag, double *z_real, double *z_imag);
...
void complex_sp_inv_cn(double y_real, double y_imag, double *z_real, double *z_imag)
{
    double y_mag, z_mag;
...
void complex_sp_div_cn(double x_real, double x_imag, double y_real, double y_imag, double *z_real, double *z_imag)
{
