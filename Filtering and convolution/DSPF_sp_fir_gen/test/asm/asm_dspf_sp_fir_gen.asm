...
|		SMOVIH			0, R47
|		VMOVIH			0, VR11
		SMVCGC.L		R42, VLR      ;P5 SIEU   ����VPE����
|		SSUB.M1			1,R16,R16
;		SMOVIL			3,	R0		  ��������	  				
;;		SMVCGC			R0,	SCR

;part3:
dspf_sp_fir_gen_LOOP1:    ;��ѭ��    6p
		SLDW			*AR10++[1],R36     ;p6
...
|		SMOVIH			0, R32
dspf_sp_fir_gen_LOOP2:   ;��ѭ��   36
		SSUB.M1 		R32,R18,R38  ;nr-j
		SSHFLL			2, R32,R42   ;2<<j
		SADD.M2			R42,R44,R48  ;x+i+j	
|		SSHFLL			4, R34,R46	 ;4<<k  
		SADD.M2		    R14,R46,R46	 ;r+k
|       SMVAGA36.M1 	R49:R48, AR3 ;x+i+j��ַ
		SMVAGA36.M1 	R47:R46, AR4 ;r+k��ַ
		SMVAGA36.M1 	R47:R46, AR5 ;�������д��r		   
