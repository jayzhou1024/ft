...
void DSP_fir_cplx_hM4X4_cn (const short  *x,const short * h, short * r, int nh,int nr);
void DSP_fir_cplx_hM4X4_vc1 (vector signed short *x,signed short *h,vector signed short  *r,int nh,int nr);
...
unsigned long get_time_cn(
	...
	DSP_fir_cplx_hM4X4_cn(x,h,r,nh,nr);
...
unsigned long get_time_vc(vector signed short *x,   
    ...
    int nr
        ...
        unsigned long time1,time2;
        time1 = GetTimerCount(0);
        DSP_fir_cplx_hM4X4_vc1(x,h,r,nh,nr);
        time2 = GetTimerCount(0);
        return time2-time1;
}