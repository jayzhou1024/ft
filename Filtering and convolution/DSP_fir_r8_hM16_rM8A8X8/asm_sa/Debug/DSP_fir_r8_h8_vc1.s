...
.LCFI1:
		...
		SNOP		1
		SSTDW		R63:R62, *+AR15[41]
		SSTDW		R41:R40, *+AR15[40]
		SSTDW		R39:R38, *+AR15[39]
		SSTDW		R37:R36, *+AR15[38]
		SSTDW		R35:R34, *+AR15[37]
		SSTDW		R33:R32, *+AR15[36]
		SSTDW		R31:R30, *+AR15[35]
.LCFI2:
		SMOVIL		-152, R46
		SMOVIL		-1, R47
		SMOVIL		-64, R42
	...
	.loc 1 27 0
		...
		SMVAAGH.M1		OR11, R47:R46
		SNOP		1
		SMOVIL		437852183, R10
		SMOVIH		437852183, R10
		SMVAGA36.M1		R47:R46, AR10
		SNOP		1
		SSTW		R10, *AR10
	.loc 1 28 0
		...
		SMVAAGH.M1		OR11, R47:R46
		SNOP		1
		SMOVIL		505224219, R10
		SMOVIH		505224219, R10
		SMVAGA36.M1		R47:R46, AR10
		SNOP		1
		SSTW		R10, *AR10
	.loc 1 29 0
		...
		SMVAAGH.M1		OR11, R47:R46
		SNOP		1
		SMOVIL		572596255, R10
		SMOVIH		572596255, R10
		SMVAGA36.M1		R47:R46, AR10
		SNOP		1
		SSTW		R10, *AR10
	.loc 1 34 0
...
.L6:
	.loc 1 186 0
		...
		SNOP		2
		SLDDW		*+AR15[35], R31:R30
		SNOP		5
		SLDDW		*+AR15[36], R33:R32
		SNOP		5
		SLDDW		*+AR15[37], R35:R34
		SNOP		5
		SLDDW		*+AR15[38], R37:R36
		SNOP		5
		SLDDW		*+AR15[39], R39:R38
		SNOP		5
		SLDDW		*+AR15[40], R41:R40
		SNOP		5
		SLDDW		*+AR15[41], R63:R62
		SNOP		5
