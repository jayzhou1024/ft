...
DSP_fir_r8_asm:
        ...
        SMOVIL		-512,R2  ;开一个16 * 8的空间
        SMOVIL		-1,R3

        SMOVI0L	    0, R50           ;初始化i
|       SADDA.M2    R3:R2,AR15,AR0  ;p2
...
|       SVBCAST.M2  R54,VR11    ;广播h1
        ...
        SVBCAST.M1  R57,VR14    ;广播h4
        SVBCAST.M2  R58,VR15    ;广播h5
        SVBCAST.M1  R59,VR16    ;广播h6
        SVBCAST.M2  R60,VR17    ;广播h7
|       SMOVI0L         0,R55   ;R55 = 0
LOOP_J:  
...
|       VMOVIH           0,VR4          ;VR4 = 0
        ...
        VLDW            *+AR3[0],VR35   ;X_0_31 (8 cycles)
|       VLDH            *+AR3[0],VR30   ;x_0_15

        VLDW            *+AR3[2],VR39   ;x_4_35
|       VLDH            *+AR3[2],VR32   ;x_2_17

        VLDH            *+AR3[4],VR34   ;x_4_19
|       VLDW            *AR4,VR3        ;r_0_15
|       SADD.M1         16,R51,R51      ;J+=16
...
|       SLT	        R51,R18,R0      ;j<nr?
        ...
        VSHUFH          VR35,VR35,VR31    ;p3   混洗(3 cycles)
|       VMULAS16T.M1    VR30,VR10,VR5,VR5 ;P3   乘加x_0_15 (3 cycles)

        VSHUFH          VR39,VR39,VR37    ;     混洗
|       VMULAS16T.M1    VR32,VR12,VR4,VR4 ;P3   乘加x_2_17
        
 [R1]   SVBCAST.M1      R55,VR3         ;VR3 = 0

        VSTW            VR31,*AR0         ;保存混洗结果(4 cycles)
|       VMULAS16T.M1    VR34,VR14,VR5,VR5 ;乘加x_4_19

        VSTW            VR37,*+AR0[OR4]   ;保存混洗结果
|       VMULAS16T.M2    VR36,VR16,VR4,VR4 ;乘加x_6_21
        SNOP            2

        VLDH            *+AR0,VR31      ;取x_1_16
|       VLDH            *+AR0[OR4],VR33 ;取x_3_18
 
        VLDH            *+AR0[OR5],VR37 ;取x_5_20
|       VLDH            *+AR0[OR6],VR38 ;取x_7_22
        SNOP            6

        VMULAS16T.M1    VR31,VR11,VR3,VR3 ;P3   乘加x_1_16
|       VMULAS16T.M2    VR33,VR13,VR4,VR4       ;乘加x_3_18

        VMULAS16T.M1    VR37,VR15,VR5,VR5       ;乘加x_5_20
        SNOP            1
        VMULAS16T.M1    VR38,VR17,VR4,VR4       ;乘加x_7_22
        VADD.M1         VR5,VR3,VR3     ;本次循环计算结果VR3
        SNOP            1
        VADD.M2         VR4,VR3,VR3     ;保存乘加中间结果
        VSTW            VR3,*AR4        ;计算结果保存
...
.size DSP_fir_r8_asm, .-DSP_fir_r8_asm
