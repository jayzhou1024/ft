...
.LVL4:
	...
	;; call to DSP_fir_cplx_cn occurs
		SNOP		2
.LVL5:
.L3:
	.loc 1 156 0
...
.LVL18:
	...
	|	SMOVIH4.L		.L7, R63
		SMVAAGH.M1		OR8, R11:R10
	|	SMVAAGH.M2		AR8, R15:R14
	;; call to DSP_fir_cplx_asm occurs, with return value
		SNOP		2
.LVL19:
.L7:
	.loc 1 169 0
...
.LASF30:
	.string	"diff_max"
.LASF38:
	.string	"/cygdrive/e/project/\351\241\271\347\233\256/ft-m7002-function-base/Filtering and convolution/DSP_fir_cplx/test/asm/Debug"
.LASF22:
	.string	"xAddr"
.LASF33:
	.string	"hAddr"
