.global DSP_fir_cplx_asm

DSP_fir_cplx_asm:
        SMOVIL		0, R50	        ;初始化i
        SMOVIH		0, R50	
        SSHFLL      2, R16,R42      ; h<<2
|       SADD.M1     0, R50,R45       ;R47 = 0
|       SADD.M2     0,R50,R49
        SMOVIL  	3,R0		    ;饱和配置 
|       SSUB.M1     4, R42,R42
|       SADD.M2     0,R50,R43
...
|       SVBCAST.M2	R1, VR1 
        SVBCAST.M1	R54, VR11
|       SMOVIH		0, R47
 [R2]   SVBCAST.M1	R55, VR12
 [R2]   SVBCAST.M1	R56, VR13 
...
|[VR2]  VCMUL16T.M2     VR12,VR32,VR25:VR24
|[VR2]  VCMUL16T.M3     VR13,VR33,VR27:VR26  
        SNOP            3
...
|       VADD.M2         VR5,VR23,VR5
 ...
 [VR2]  VADD.M1         VR4,VR24,VR4
|[VR2]  VADD.M2         VR5,VR25,VR5

 [VR2]  VADD.M1         VR4,VR26,VR4
|[VR2]  VADD.M2         VR5,VR27,VR5
        VSTDW	        VR5:VR4, *AR4  
|[R0]   SBR		        LOOP_J
|	SADD.M1	        1, R52,R52 
        SNOP	     	6
...
.size DSP_fir_cplx_asm, .-DSP_fir_cplx_asm
